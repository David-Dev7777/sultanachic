...
export interface ApiCatalogoPageCatalogoPage extends Struct.SingleTypeSchema {
  collectionName: 'catalogo_pages';
  info: {
    displayName: 'catalogo_page';
    pluralName: 'catalogo-pages';
    singularName: 'catalogo-page';
  };
  options: {
  ...
  attributes: {
    ...
    banner_mobile: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    catalogo_section: Schema.Attribute.DynamicZone<
      [
        'layout.hero-section',
        'layout.product-section',
        'layout.header',
        'layout.footer',
        'layout.product-filters',
      ]
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::catalogo-page.catalogo-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aroma: Schema.Attribute.Enumeration<
      ['Floral', 'Amaderado', 'Frutal', 'Oriental', 'Fresco', 'Citrico']
    >;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    volumen: Schema.Attribute.Enumeration<['ml50', 'ml100', 'ml150']>;
  };
}

export interface ApiTipoAromaTipoAroma extends Struct.CollectionTypeSchema {
  collectionName: 'tipo_aromas';
  info: {
    displayName: 'tipo_aroma';
    pluralName: 'tipo-aromas';
    singularName: 'tipo-aroma';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::catalogo-page.catalogo-page': ApiCatalogoPageCatalogoPage;
      'api::coleccion.coleccion': ApiColeccionColeccion;
      'api::home-page.home-page': ApiHomePageHomePage;
      'api::marca.marca': ApiMarcaMarca;
      'api::producto.producto': ApiProductoProducto;
      'api::tipo-aroma.tipo-aroma': ApiTipoAromaTipoAroma;
